...
constexpr double driver_deadzone = 0.05;                //Joystick Deadzone
...
constexpr double elevator_handoff_height = 26.5 - elevator_hatch_displacement;
constexpr double elevator_handoff_raise = 13;

constexpr double elevator_loading_station_displacement = 6;
...
constexpr double elevator_deadband = 1.5;                 //Range of stalling, inches
...
constexpr double ball_acquired_LED_time = 0.15;         //Blinks three times
...
constexpr double limelight_angle_offset = 14.5;         //Tilted Left
