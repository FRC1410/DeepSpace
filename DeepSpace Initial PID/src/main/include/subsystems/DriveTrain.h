...
class DriveTrain : public frc::Subsystem {
  ...
  public:
    ...
    bool GetRightSensor();
    double GetDistancePID(double previous_error, double target, double time_difference);
    void ResetDistanceIntegral(); 
    double GetGyroPID(double previous_error, double target, double time_difference);
