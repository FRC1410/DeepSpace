...
constexpr double drivetrain_gyro_kP = 0;//0.03;             //PID Tuning was 0.019
...
constexpr int hatch_pickup_rotator = 33;                //Talon
...
constexpr int hatch_pickup_rotator_axis = 254;            //Right Stick Y-Axis
constexpr int hatch_pickup_rotator_button = 254;          //R
constexpr int hatch_stick_button = 5;                   //L
constexpr int hatch_pickup_toggle_button = 254;           //Hatch handoff button

constexpr double hatch_pickup_up_position = 0;//0.05;       //Encoder when raised
constexpr double hatch_pickup_down_position = 0;//0.75;     //Encoder when lowered

constexpr double hatch_handoff_time = 0;//0.3;              //Time rotator spends pushing on stick
constexpr double hatch_pickup_down_power = 0;//0.5;         //Handoff Power
constexpr double hatch_pickup_up_power = 0;//-0.45;         //Handoff Power
constexpr double hatch_pickup_stall_power = 0;//0.05;       //Power when down
...
constexpr double limelight_x_offset = 17.5;//9.5;              //9.5 //Right of center of rotation
