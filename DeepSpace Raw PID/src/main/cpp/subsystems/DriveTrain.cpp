...
void DriveTrain::SetSpeed(double left, double right) {
  ...
  frc::SmartDashboard::PutNumber("Left Drivetrain", left_velocity);
  frc::SmartDashboard::PutNumber("Right Drivetrain", right_velocity);
}
...
double DriveTrain::GetDistance() {
  ...
  //return ((GetRightDistance() - GetLeftDistance()) / 2) * (6 * pi / /*4096*/1024);return ((GetRightDistance() - GetLeftDistance()) / 2) * (6 * pi / /*4096*/1024);
  return ((GetRightDistance() + GetLeftDistance()) / 2) * (6 * pi / /*4096*/1024);return ((GetRightDistance() - GetLeftDistance()) / 2) * (6 * pi / /*4096*/1024);
}
