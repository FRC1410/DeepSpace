...
constexpr double drivetrain_width = 11;                 //Inches
...
//Limelight
constexpr double limelight_x_offset = 20;
constexpr double limelight_z_offset = 20;
constexpr double limelight_angle_offset = 20;
