...
void HatchPickupRotate::Initialize() {
  ...
  Robot::m_hatch_pickup.ResetIntegral();
}
...
void HatchPickupRotate::Execute() {
      ...
      if (Robot::m_hatch_pickup.GetState() == true) {
        if (Robot::m_macro_superstructure.GetHandoffState() == 0) {
          if (Robot::m_hatch_pickup.GetPosition() > hatch_pickup_up_position) {
            ...
            //Robot ::m_hatch_pickup.RotatePickup(Robot::m_hatch_pickup.GetPID(hatch_pickup_up_position, timer.Get()));
          ...
          if (Robot::m_hatch_pickup.GetPosition() < hatch_pickup_down_position) {
            ...
            //Robot::m_hatch_pickup.RotatePickup(Robot::m_hatch_pickup.GetPID(hatch_pickup_down_position, timer.Get()));
  ...
  frc::SmartDashboard::PutNumber("Hatch Pickup Position", Robot::m_hatch_pickup.GetPosition());
