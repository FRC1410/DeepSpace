...
void Drive::Execute() {
  ...
  if (Robot::m_macro_superstructure.GetAuto() == false) {
    ...
    if (Robot::m_oi.GetDriverButton(limelight_toggle_button) == true) {
      ...
      limelight_toggle_was_pressed = true;
    } else {
      limelight_toggle_was_pressed = false;
    }
    ...
    if (Robot::m_oi.GetDriverButton(vision_align_button) == true) {
      ...
      if (Robot::m_limelight.GetCamtranSize() > 0) {
      ...
      Robot::m_drivetrain.SetCurvedSpeed((Robot::m_oi.CalculateAntiAntiFriction() + Robot::m_limelight.GetPID(Robot::m_limelight.GetTargetX() - limelight_x_offset, 1)), (Robot::m_oi.CalculateAntiAntiFriction() - Robot::m_limelight.GetPID(Robot::m_limelight.GetTargetX() - limelight_x_offset, 1)));    
      //Robot::m_limelight.SetModeDriver();
  ...
  Robot::m_drivetrain.GetLeftDistance();
  Robot::m_drivetrain.GetRightDistance();
}
