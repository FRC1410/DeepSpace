...
void Drive::Execute() {
  ...
  if (Robot::m_macro_superstructure.GetAuto() == false) {
    ...
    if (Robot::m_oi.GetDriverButton(limelight_toggle_button) == true) {
      if (limelight_toggle_was_pressed == false) {
        if (Robot::m_limelight.GetPipeline() == 0) {
    ...
    if (Robot::m_oi.GetDriverButton(vision_align_button) == true) {
      ...
      if (Robot::m_limelight.GetTarget() == 0) {
  ...
  previous_x[sizeof(previous_x) / 8 - 1] = Robot::m_drivetrain.GetX();
  previous_z[sizeof(previous_z) / 8 - 1] = Robot::m_drivetrain.GetZ();
  ...
  frc::SmartDashboard::PutNumber("X Pos", Robot::m_drivetrain.GetX());
  frc::SmartDashboard::PutNumber("Z Pos", Robot::m_drivetrain.GetZ());
  frc::SmartDashboard::PutNumber("Target?", Robot::m_limelight.GetTarget());
  frc::SmartDashboard::PutNumber("Target?", Robot::m_limelight.GetTarget());
  ...
  frc::SmartDashboard::PutNumber("NavX Angle", Robot::m_drivetrain.GetAngle());

  frc::SmartDashboard::PutNumber("Target Angle", Robot::m_drivetrain.GetTargetAngle());
  ...
  frc::SmartDashboard::PutNumber("Thor", Robot::m_limelight.GetTargetWidth());
  frc::SmartDashboard::PutNumber("Tvert", Robot::m_limelight.GetTargetHeight());
