...
constexpr double elevator_cargo_ship_height = 41 - elevator_ball_displacement;
...
constexpr double elevator_max_height = 85;              //Max Height
...
//Climber
constexpr int climber_left_stilt = 13;
constexpr int climber_right_stilt = 14;
constexpr int climber_arm = 15;

constexpr int climber_stilt_axis = 1;
constexpr int climber_arm_axis = 5;
constexpr int climber_forward_axis = 3;
constexpr int climber_backward_axis = 4;
...
constexpr double limelight_x_offset = 9.5;             //9.5 //Right of center of rotation
constexpr double limelight_y_offset = 32;             //32  
constexpr double limelight_z_offset = 1;              //1  //Infront of center of rotation
...
//Zoning
constexpr double hab_line = 94;
constexpr double left_mid_line = -70;
constexpr double right_mid_line = 70;
constexpr double upper_zone_line = 227;
constexpr double mid_line = 0;

constexpr double front_left_rocket_angle = 151.25;      //Noting that the Angle increases going clockwise
constexpr double front_right_rocket_angle = 208.75;    
constexpr double front_cargo_ship_angle = 180;
constexpr double left_cargo_ship_angle = 270;
constexpr double right_cargo_ship_angle = 90;
constexpr double human_player_station_angle = 0;
constexpr double back_left_rocket_angle = 28.75;
constexpr double back_right_rocket_angle = 331.25;