...
void Climber::RaiseStilts(double speed) {
  ...
  frc::Shuffleboard::GetTab("Debugging")
  .Add("Climber Stilts", "Raised");
}

void Climber::LowerArm(double speed) {
  //m_arm.Set(speed);
}