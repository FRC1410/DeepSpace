...
//Hatch
constexpr int hatch_wheels_left = 8;          //Talon
constexpr int hatch_wheels_right = 9;         //Talon

constexpr int hatch_intake_button = 1;        //A
constexpr int hatch_outtake_button = 2;       //B

//Ball Intake and Claw
constexpr int ball_claw_left = 5;             //Talon
constexpr int ball_claw_right = 6;            //Talon
constexpr int ball_intake = 7;                //Talon

constexpr int ball_claw_outtake_button = 5;   //L
constexpr int ball_claw_intake_button = 6;    //R
constexpr int ball_roller_intake_button = 3;  //X
constexpr int ball_roller_outtake_button = 4; //Y

//Spark Maxes
constexpr int spark_max_test = 10;