...
class Limelight : public frc::Subsystem {
  private:
    ...
    nt::NetworkTableEntry shuffleboard_vision = frc::Shuffleboard::GetTab("Drivers").Add("Vision Target", false).WithWidget(frc::BuiltInWidgets::kBooleanBox).WithPosition(5, 0).WithSize(2, 1).GetEntry();
